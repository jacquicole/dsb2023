...
-   How many (as a number and %) donated to MPs belonging to a single party only?
    ...
    #
    # First, we determine how many party_id and abbrev
    #
    parmempay %>%
    ...
    #These results show that there are only 13 distinct party_ids and only 13 distinct parties. Since each member_id has a particular party_id, and we expect an MP to be a member of only one party, this makes sense. But are the donors less loyal to a party than their MP?
    ...
    #
    # These all show that all MPs are entirey loyal to one party (there are 595 distinct MPs and 595 combinations of MPs and Party categories, so this proves that there is a one-to-one mapping between them).
    #
