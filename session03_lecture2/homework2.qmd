...
mass_shootings %>%
  ...
  ggplot(mapping = aes(total_victims)) + geom_bar() + facet_wrap(vars(prior_mental_illness))
...
mass_shootings %>%
  ...
  ggplot(mapping = aes(location_type)) + geom_bar() + facet_wrap(vars(prior_mental_illness)) + theme(axis.text = element_text(size=5))
...
mass_shootings %>%
  ...
  ggplot(mapping = aes(x = total_victims)) + geom_histogram() + facet_grid(rows = vars(location_type), cols = vars(prior_mental_illness)) + theme(axis.text = element_text(size=5),strip.text.y = element_text (size = 4))
